      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-3 py-2 bg-white border rounded-md text-sm font-medium text-gray-700 hover:bg-gray-100"
                disabled={isSending}
              >
                Save Template
              </button>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-1 mb-2 max-h-32 overflow-y-auto border rounded-md p-2 bg-white">
            ...
            <div className="flex gap-2 mt-1">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-white border rounded-md text-xs font-medium text-gray-700 hover:bg-gray-100 disabled:opacity-50"
                disabled={isSending}
              >
                Add
              </button>
            ...
            <div className="mt-3 space-y-1 text-[11px] text-gray-700">
              <div className="flex gap-2 flex-wrap items-center">
                <button
                  ...
                  className="px-2 py-1 rounded-full border border-gray-300 bg-white hover:bg-gray-100"
